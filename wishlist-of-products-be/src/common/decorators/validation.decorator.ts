...
export const IsString = (validationOptions?: validator.ValidationOptions) =>
	applyDecorators(
		validator.IsString({ ...validationOptions })
	);
...
export const IsEmail = (validationOptions?: validator.ValidationOptions) =>
	applyDecorators(
		validator.IsEmail({}, { ...validationOptions})
	);
...
export const MinLength = (minValue: number, validationOptions?: validator.ValidationOptions) =>
	applyDecorators(
...
export const MaxLength = (maxValue: number, validationOptions?: validator.ValidationOptions) =>
	applyDecorators(
